...
public class ChromeTabCreator extends TabCreatorManager.TabCreator {
     ...
     */
    @Override
    public Tab createNewTab(LoadUrlParams loadUrlParams, TabLaunchType type,
            Tab parent) {
     ...
     * @return The new tab.
     */
    private Tab createNewTab(LoadUrlParams loadUrlParams, TabLaunchType type,
     ...
     */
    public Tab launchUrl(String url, TabLaunchType type, Intent intent,
