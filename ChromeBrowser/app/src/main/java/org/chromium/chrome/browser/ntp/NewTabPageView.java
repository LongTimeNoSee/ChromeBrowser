...
public class NewTabPageView extends FrameLayout
    ...
    public void initialize(NewTabPageManager manager, boolean isSingleUrlBarMode,
        ...
        mSearchBoxTextView.setOnClickListener(new OnClickListener() {
            @Override
        ...
        mVoiceSearchButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        toolbar.getRecentTabsButton().setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mManager.navigateToRecentTabs();
            }
        });
        toolbar.getBookmarksButton().setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mManager.navigateToBookmarks();
            }
        });
        toolbar.getInterestsButton().setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
